...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("jumlah cuti : "+ myPegawai1.getCuti());
        myPegawai2.setCuti("persalinan");
        System.out.println("jumlah cuti : "+ myPegawai2.getCuti());
